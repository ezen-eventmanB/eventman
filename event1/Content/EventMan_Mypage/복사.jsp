...
<div class="mypageajax">
	...
	<div class="container" id="myboardbox">
		...
		<div class="text-end">
			<button type="button" class="btn btn-outline-secondary btn-sm" onclick="loction.href='<%=request.getContextPath()%>/EventMan_Board/EventMan_Mypage_Myboardlist.do?midx=<%=bavo.getMidx()%>'">목록으로</button>
			<button type="button" class="btn btn-outline-secondary btn-sm" onclick="">게시글 수정하기</button>
		</div>
	</div>
