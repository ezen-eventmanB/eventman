...
/*	비밀번호 찾기 ACTION	*/
			 ...
			 * 
			 * String id = request.getParameter("id"); String email =
			 ...
			 * 
			 * if(mvo==null || !mvo.getmEmail().equals(email)) { request.setAttribute("msg",
			 * "아이디나 이메일 정보가 맞지 않습니다");
			 * 
			 * RequestDispatcher rd
			 * =request.getRequestDispatcher("/EventMan_Member/EventMan_Member_Find_Pw.jsp "
			 * ); rd.forward(request, response);
			 * 
			 * return; }else {
			 * 
			 * //mail server 설정 String host = "smtp.naver.com"; String user =
			 * "maen2@naver.com"; //자신의 네이버 계정 String password = "hwang9295A!";//자신의 네이버
			 * 패스워드
			 * 
			 * //메일 받을 주소 String to_email = mvo.getmEmail();
			 * 
			 ...
			 * for(int i=0;i<10;i++){ int rIndex = rnd.nextInt(3); switch (rIndex) { case 0:
			 * // a-z temp.append((char) ((int) (rnd.nextInt(26)) + 97)); break; case 1: //
			 * A-Z temp.append((char) ((int) (rnd.nextInt(26)) + 65)); break; case 2: // 0-9
			 * temp.append((rnd.nextInt(10))); break; } } String AuthenticationKey =
			 * temp.toString();
			 ...
			 * 
			 * 
			 * //email 전송 try { System.out.println("try입니다.");
			 * 
			 * ////////////////////////////////////
			 * 
			 * MimeMessage msg = new MimeMessage(session); System.out.println("↑exception");
			 * 
			 * msg.setFrom(new InternetAddress(user, "EVENTMAN"));
			 * msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to_email));
			 * 
			 * //메일 제목 msg.setSubject("안녕하세요 EVENTMAN 인증 메일입니다."); //메일 내용
			 * msg.setText("인증 번호는 :"+temp);
			 * 
			 * Transport.send(msg); System.out.println("이메일 전송");
			 * 
			 * }catch (Exception e) { System.out.println("catch입니다.");
			 * e.printStackTrace();// TODO: handle exception } HttpSession saveKey =
			 * request.getSession(); saveKey.setAttribute("AuthenticationKey",
			 * AuthenticationKey);
			 * 
			 * //패스워드 바꿀때 뭘 바꿀지 조건에 들어가는 id
			 * 
			 * request.setAttribute("id", id); RequestDispatcher rd
			 * =request.getRequestDispatcher("/EventMan_Member/EventMan_Member_Find_Pw.jsp "
			 * ); rd.forward(request, response); } }
			 */
